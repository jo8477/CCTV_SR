...
from data_uti import DatasetFromFolder
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_epochs', default=50, type=int, help='super resolution epochs number')
    ...
    # import numpy as np
    # img1, img2 = train_set.__getitem__(0)
